...
if [ "$current_scheme" = "'prefer-light'" ]; then
    ...
    # Mode Sombre Profond (Match total avec Hyprland / Quickshell #0b0b14)
    bg_color="#0b0b14"
    fg_color="#ffffff"
    card_color="#181825"
    accent_color="#89b4fa"
...
# open rofi grid gallery forcing complete background-color override
